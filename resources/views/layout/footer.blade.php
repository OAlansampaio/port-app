         ...
         <div class="w-full sm:w-2/3 lg:w-3/12 px-4">
            <div class="w-full mb-10">
               ...
               <p class="text-base text-body-color mb-7">
                Comece com simples, Use o que você tem, Faça o que você pode, de o seu melhor..
               </p>
         ...
         <div class="w-full sm:w-1/2 lg:w-3/12 px-4">
            <div class="w-full mb-10">
               ...
               <div class="flex items-center mb-6">
                  ...
                  <a
                     href="https://www.linkedin.com/in/alansampaioo/"
                     class="
                     w-8
                     h-8
                     flex
               ...
               <p class="text-base text-body-color">&copy; Araujo 2022</p>
            </div>
         </div>
      </div>
   </div>
