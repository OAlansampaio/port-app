                  ...
                  <div class="flex items-center -mx-3 sm:-mx-4">
                      ...
                      <div class="w-full xl:w-1/2 px-3 sm:px-4">
                          <div class="my-4 relative z-10">
                              <img src="{{ url('img\Alan Araujo.jpeg') }}" alt="Kowalski"
              ...
              <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                  <div class="mt-10 lg:mt-0">
                      ...
                      <p class="text-base dark:text-gray-400 mb-8">
                          Atualmente trabalho como Analista de dados sou profissional.<br />
                          Durante minha carreira trabalhei em vários empregos, agora trabalho com projetos estatisticos de indicação com machine learning, mais ainda
                          sinto muitas vezes que sou um Analista que tem muito a aprender... <br />
                      </p>
                        
                      <p class="text-base dark:text-gray-400 mb-8">
                          Atualmente trabalho com Analises na empresa:<br />
                      </p>
                      <div>
                          <p class="text-base dark:text-gray-400 mb-8">
                              Sicoob<br />
